...
This is a standalone phase — it does not go through the controller. It
discovers PRs by querying GitHub for the `acp:document-review` label and
operates without prior workflow context.
